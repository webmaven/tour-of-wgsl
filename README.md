...
No special flags or nightly builds are required. If the examples do not render, check that your device's GPU drivers are up to date and that hardware acceleration is enabled in your browser settings.
