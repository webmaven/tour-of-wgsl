...
1. Zero-value constructor: <span class="template">mat(C)x(R)f()</span> or <span class="template">mat(C)x(R)&lt;f32&gt;()</span>
...
1. Column-wise constructor: <span class="template">mat(C)x(R)&lt;f32&gt;(column_0, column_1, ...)</span>
...
1. Scalar-wise constructor: <span class="template">mat(C)x(R)&lt;f32&gt;(column_0_row_0, column_0_row_1, ...)</span>
